...
public class SkillClosestToLevelingAdapter {
    ...
    public View getView (ViewGroup parent) {
        ...
        View root = LayoutInflater.from(getContext()).inflate(R.layout.skill_closest_to_leveling, parent, false);
        ...
        TextView skillLabel = (TextView) root.findViewById(R.id.skill_label);
        skillLabel.setText(skill.getSkillLabel());

        //Set the level number text
        TextView levelLabel = (TextView) root.findViewById(R.id.level_label);
        levelLabel.setText("Level: " + skillLevel);

        //Set the exp to next level text
        TextView expToNextLevel = (TextView) root.findViewById(R.id.xp_to_next_level);
        expToNextLevel.setText(nextLevelXP-currentXP + " xp to go");

        //Set current level text
        TextView currentLevel = (TextView) root.findViewById(R.id.current_level);
        currentLevel.setText(skillLevel+"");

        //Set next level text
        TextView nextLevel = (TextView) root.findViewById(R.id.next_level);
